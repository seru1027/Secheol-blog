      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        <Container>
          <div className="relative z-10 mx-auto max-w-4xl text-center">
            ...
            <h1 className="font-display text-7xl font-extrabold tracking-tight sm:text-9xl mb-8">
              Code with <br />
        ...
        <Container>
          <div className="flex items-end justify-between mb-12">
            <div>
              ...
              <p className="text-zinc-500">최근 생각의 편린들을 모았습니다.</p>
            </div>
            <Link href="/blog" className="text-sm font-semibold text-primary hover:text-accent transition-colors flex items-center gap-1 group">
              View Architecture
              ...
              <BentoCard isFeatured className="p-8 md:p-12 justify-center">
                <div className="flex-1">
                  <div className="flex items-center gap-x-4 mb-6">
                    <time dateTime={featuredPost.date} className="text-sm font-medium text-zinc-500">
                      {formatDate(featuredPost.date)}
                    </time>
                    <span className="px-3 py-1 rounded-full bg-primary/20 text-xs font-bold text-primary border border-primary/30 uppercase tracking-widest">
                      Featured
                    </span>
                  </div>
